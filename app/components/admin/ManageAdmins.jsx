...
export default function ManageAdmins() {
  ...
  const handleAction = async (adminId, action) => {
    ...
    try {
      ...
      console.error(`Error ${action} admin:`, err);
  ...
  return (
    ...
    >
      <h2 className="text-4xl font-bold text-[#001948] mb-8">Manage Admins</h2>
            ...
            {filteredAdmins.map((admin) => (
              ...
              >
                ...
                <td className="px-6 py-4">
                  <span className={`px-3 py-1 rounded-full text-sm font-semibold ${getStatusBadgeColor(admin.status)}`}>
                ...
                <td className="px-6 py-4">
                  <div className="flex gap-2">
                    ...
                    >
                      {actionLoading === `${admin.id}-delete` ? "..." : "Delete"}
                    </button>
                  </div>
                </td>
              </motion.tr>
